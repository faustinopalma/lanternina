...
Run on 25 August 2026, 09:36, in 268 s.
...
03. **page** sh_553c9dfd handed over
04. **came back** sh_553c9dfd — written on by the model
...
07. **page** sh_d50f63cd handed over
08. **came back** sh_d50f63cd — written on by the model

## Ink

- 03-page-handed-over.png: 1.6 % of the sheet
- 04-page-came-back.png: 4.24 % of the sheet
- 07-page-handed-over.png: 1.36 % of the sheet
- 08-page-came-back.png: 3.84 % of the sheet
