...
Quello che si sa e che conta è un limite nostro, già misurato e registrato in `ideas/10 §6`: **il sistema non sa manipolare le lettere dentro le parole.** Quindi non può generare un testo cifrato e verificarlo, e non può costruire una traduzione lettera per lettera. Può però stampare una **legenda** e lasciare che sia chi legge a fare la conversione — è la conclusione della scheda 005, e qui torna.

La direzione conta: **decifrare è alla portata del sistema, cifrare no.** Se la legenda è sul foglio e il testo cifrato è stato prodotto da noi, dobbiamo averlo prodotto correttamente, e questo è il punto che non regge. Se invece è chi legge a cifrare, il foglio non deve verificare niente.
...
Da scrivere fra i limiti tecnici: *il sistema non stampa mai un testo che ha cifrato lui.* Non sa farlo in modo affidabile, e un cifrato sbagliato è un vicolo cieco senza uscita — che è la peggiore cosa che questo formato possa produrre, perché viola la garanzia che ogni percorso arrivi da qualche parte.
