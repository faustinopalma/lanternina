...
- **Fonti** `travelling-salesman.txt` e `shortest-path-problem.txt`, prese il 30 agosto 2026 da en.wikipedia; il conto sui 181 440 giri è nostro
...
Sul pannello da quattro righe da 44 caratteri la disposizione dei dieci punti non ci sta, e questa è una forma da foglio senza rimedio. Ci starebbe una cosa sola, ed è il numero: «il tuo giro più corto finora: 412 mm».

Il limite tecnico da dichiarare è che **il sistema non può certificare l'ottimo** di una configurazione che stampa. Ma qui non deve: nessuno lo chiede, e la consegna è costruita perché nessuno lo debba chiedere.

## Da riprendere alla rassegna

**È quasi l'unica forma dell'elenco in cui tutte le risposte sono giuste e alcune sono migliori.** Non «non c'è una risposta giusta», che è il caso di metà del capitolo 1: qui c'è un ordine fra le risposte, misurabile, e non c'è un massimo raggiungibile. **Nessuno deve sapere niente, e nessuno può barare**, perché il numero si misura con un righello. Alla rassegna vale la pena censire quante altre forme si possano riformulare così — prendere un compito con una risposta e chiedere invece la risposta più corta, più leggera, più economica.
...
**Una regola stampata che dà una risposta valida senza pensare è il piolo più basso raccolto finora.** Non è un suggerimento e non toglie niente al problema, perché la risposta che produce è quella da battere. Vale la pena cercare, per ogni forma dell'elenco che abbia una soglia d'ingresso alta, se esista una regola meccanica che produca una risposta mediocre. Nel giro più corto si chiama euristica del vicino più prossimo e ha novant'anni.
