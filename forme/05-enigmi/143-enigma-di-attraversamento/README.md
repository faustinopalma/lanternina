...
- **Fonti** `river-crossing-puzzle.txt`, `wolf-goat-cabbage.txt` e `missionaries-and-cannibals.txt`, prese il 30 agosto 2026 da en.wikipedia
...
Il sistema stampa la storia e una griglia di stato, e non deve sapere la risposta: la sequenza si verifica eseguendola. Questa è la prima forma di tutto il blocco in cui non c'è nessun limite tecnico da aggirare.
