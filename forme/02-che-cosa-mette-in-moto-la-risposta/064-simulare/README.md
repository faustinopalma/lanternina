...
- **Fonti** `_reference/esercizi-e-sfide/simulation.txt` e `cellular-automaton.txt`, lette il 30 agosto 2026; le regole del *Gioco della vita* sono a memoria
...
> ```
>
> Le regole sono quelle del *Gioco della vita*, l'automa cellulare inventato da John Conway; secondo `cellular-automaton.txt` è negli anni Settanta che rende popolare la cosa. Le ho riscritte con altre parole. Non c'è niente da vincere: la griglia fa quello che fa.
...
Nel nostro formato regge, con un costo: cinque griglie 10 × 10 su un A4 stanno, ma strette; due fogli sono meglio. Il limite vero è un altro, ed è nostro — **il sistema non può verificare che le cinque griglie siano giuste**, perché dovrebbe eseguire la stessa simulazione e confrontarla cella per cella. La verifica sta nella regola stessa: chi sbaglia una cella se ne accorge alla sera dopo, perché la figura smette di comportarsi come le altre.
...
**Il sistema non può verificare l'esecuzione, e non serve.** La regola è il proprio controllo dell'errore, come i pezzi che entrano in un modo solo di Montessori. Da censire: quante forme dell'elenco hanno un controllo dell'errore fatto di una regola invece che di un oggetto.
