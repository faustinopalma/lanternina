...
- **Fonti** `it-sciarada.txt`, `it-intarsio.txt`, `riffle-shuffle-permutation.txt`, prese il 1 settembre 2026
- **Stato della ricerca** fatta, 1 settembre 2026

## Che cos'è

Le due parole non si accostano: si intrecciano. `it-sciarada.txt` la scrive **XX / YY = XYXY** e porta *cane / pira = capinera* — i pezzi sono *ca, pi, ne, ra*, e si prendono a due lettere per volta, prima dalla prima parola e poi dalla seconda.
...
- **Intarsio (tarsia)** (330) — la stessa famiglia delle letture alterne, con un vincolo in più: `it-intarsio.txt` chiede che il capo e la coda della prima parola restino agli estremi del totale. Nella sciarada alterna il totale comincia con la prima parola e finisce con la seconda; nell'intarsio comincia e finisce con la prima.
...
Da `it-sciarada.txt`, riscritto: *cane / pira = capinera*, con i blocchi di due.

Da `it-intarsio.txt`, per confronto e non come esempio di questa voce: *asine / censo = ascensione* è un intarsio, perché comincia con *as* e finisce con *ne*, cioè con capo e coda della prima parola.
