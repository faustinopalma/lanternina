...
- **`something_not_in_a_house`** — it needs an object that is not paper, pencils, scissors, tape, the table, the window, the tap, what is in a kitchen drawer, or what came off the printer. An unusual object is allowed if the activity hands it over as something found, and it must be an ordinary thing. Name the object.
