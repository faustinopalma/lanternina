export const presentation = {
  it: {
    ...
    technologyTitle: "La casa tiene il tempo. Il cloud prepara le risposte.",
    homeTitle: "Un hub Linux",
    homeText: "Coordina orari, stampa, display e fotografie.",
    cloudTitle: "Un'API su Azure Container Apps",
    cloudText: "Chiama i modelli su Microsoft Foundry.",
    modelRoles: [
      ["Linguaggio", "Inventa e continua l'attività."],
      ["Immagine", "Disegna le pagine."],
      ["Visione", "Legge ciò che torna."],
    ],
  ...
  en: {
    ...
    technologyTitle: "The house keeps time. The cloud prepares the replies.",
    homeTitle: "A Linux hub",
    homeText: "Coordinates timing, printing, displays and photographs.",
    cloudTitle: "An API on Azure Container Apps",
    cloudText: "Calls models on Microsoft Foundry.",
    modelRoles: [
      ["Language", "Devises and continues the activity."],
      ["Image", "Draws the pages."],
      ["Vision", "Reads what comes back."],
    ],
