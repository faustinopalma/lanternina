...
- **Fonti** [Cruciverba](https://it.wikipedia.org/wiki/Cruciverba) e [La Settimana Enigmistica](https://it.wikipedia.org/wiki/La_Settimana_Enigmistica), prese il 1 settembre 2026; [Crossword](https://en.wikipedia.org/wiki/Crossword), presa il 30 agosto 2026 e riletta. La pagina `Cruciverba crittografato` non esiste in italiano e `Cipher crossword` in inglese rimanda a `Crossword`, controllato il 1 settembre 2026: la trattazione sta dentro le due pagine generali
...
- **Se l'alfabeto è tutto usato.** «Crossword» dice che i crittografati inglesi sono quasi sempre pangrammatici, cioè usano tutte e ventisei le lettere, e che per questo conviene cominciare cercando dove stiano la Q e la U.
...
**Un crittografato si può stampare ma non si può comporre a macchina.** Sostituire una lettera con un numero è un'operazione meccanica su una griglia già scritta. Costruire la griglia no. Quella stampata più sotto è stata composta a mano e poi controllata casella per casella, che ogni numero corrisponda alla sua lettera e che due lettere non ne condividano uno.
...
**Dove si romperebbe.** La griglia non si compone a macchina: le due parole e la loro lettera comune sono state scelte a mano. Si può però stampare una griglia già composta e sostituire le lettere con i numeri, che è un'operazione meccanica. Su un pannello di quattro righe la griglia non entra; entra la riga «il 7 vale A», che da sola non dice niente.

## Che cosa la rende interessante

**Un aiuto può aprire un problema senza chiuderlo, e le due cose vanno contate separatamente.** La lettera regalata toglie venti possibilità su ventuno e non basta; a chiudere è il numero degli incroci, che non è un aiuto ma la forma stessa del gioco. In ogni forma vale la pena distinguere che cosa permetta di *cominciare* da che cosa permetta di *finire*.
