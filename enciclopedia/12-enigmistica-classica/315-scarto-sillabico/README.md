...
- **Fonti** [Scarto (enigmistica)](https://it.wikipedia.org/wiki/Scarto_(enigmistica)), [Divisione in sillabe](https://it.wikipedia.org/wiki/Divisione_in_sillabe), prese il 1 settembre 2026
...
- **L'unità è la meno certa di tutte e sei.** Le lettere si contano e nessuno discute; le sillabe no. «Divisione in sillabe» dichiara che le norme sono «completate da alcune convenzioni in parte arbitrarie», che sui sintagmi con apostrofo «le fonti non concordano affatto», e porta un caso in cui due dizionari danno due divisioni: *subacqueo* è *su-bac-queo* per il Garzanti e forse *su-bac-que-o* per il De Mauro.
...
«Scarto (enigmistica)» definisce lo scarto come il togliere «una lettera o una sillaba», e da lì in poi tratta soltanto le lettere: i cinque tipi che elenca — di consonante, di vocale, iniziale, finale, di estremi — sono tutti di lettera, e nessuno degli esempi è sillabico. Come per la voce 312, zeppa sillabica, la fonte enigmistica nomina la forma e non la sviluppa.
...
Nessuna misura nelle fonti prese. «Scarto (enigmistica)» è un repertorio e «Divisione in sillabe» è una pagina di norme ortografiche.

Quello che si può contare è lo spazio di ricerca, e il conto è banale e per questo interessante: **su una parola di *k* sillabe i candidati sono *k*.** Su *marito*, tre sillabe, sono *rito*, *mato*, *mari*, e due su tre sono parole (il giudizio su quali siano parole è nostro, perché in casa non c'è un vocabolario garantito). Su *subacqueo* sono tre o quattro secondo la divisione che si adotta, ed è il caso in cui **il numero di risposte possibili dipende da quale dizionario si tiene in mano.**

Vale il limite dell'intero capitolo: **un modello linguistico non sa manipolare le lettere dentro le parole** (misurato), e non sa dividere in sillabe.

## Esempi trovati

Nessun esempio sillabico nelle fonti: «Scarto (enigmistica)» dà solo scarti di lettera — *porzione / pozione*, *bacio / baco*, *cappello / appello*, *Gange / gang*, *asporto / sport*, e la successione *partente / parente / parete / prete*.

Da «Divisione in sillabe», le divisioni che servono a costruire esempi: *te-ne-re*, *la-vo-ro*, *tet-to*, *ac-qua*, *am-pio*, *mol-to*, *o-stri-ca*, e i due *su-bac-queo* / *su-bac-que-o*.
...
Dove si romperebbe: un modello linguistico non sa dividere in sillabe, quindi non può né proporre la parola né controllare la divisione. La citazione dei due dizionari viene da «Divisione in sillabe» e non dai dizionari stessi, e questo va detto sul foglio o no a seconda di chi legge.
