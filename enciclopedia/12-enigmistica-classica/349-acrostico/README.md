...
- **Fonti** [Acrostico](https://it.wikipedia.org/wiki/Acrostico), [Gioco enigmistico](https://it.wikipedia.org/wiki/Gioco_enigmistico), [Acrostic (puzzle)](https://en.wikipedia.org/wiki/Acrostic_%28puzzle%29), [Notarikon](https://it.wikipedia.org/wiki/Notarikon), [Telestico](https://it.wikipedia.org/wiki/Telestico), [Word square](https://en.wikipedia.org/wiki/Word_square), prese il 1 settembre 2026. [Acrostic](https://en.wikipedia.org/wiki/Acrostic) è già la fonte della voce 122, acrostico e qui non si ripete

## Che cos'è

Un testo in cui le lettere iniziali di ogni riga, lette in verticale, dicono un'altra cosa. «Acrostico», presa il 1 settembre 2026, allarga la definizione più di quanto ci si aspetti: non solo le lettere, ma anche «le sillabe o le parole iniziali», e non solo di versi — «sono definiti acrostici anche i termini che risultano dalle lettere iniziali di singole parole anziché di versi».

**In enigmistica italiana l'acrostico non è un gioco: è uno schema.** «Gioco enigmistico», presa lo stesso giorno, tiene separate le due parole, e insiste sulla distinzione: uno schema è una relazione fra parole, un gioco è quello che qualcuno costruisce sfruttando lo schema. L'acrostico compare in quella pagina in un elenco preciso — «gli schemi complessi, desueti o rari come l'acrostico, il mesostico, il telestico, il logogrifo, il metanagramma» — cioè fra le relazioni che quasi nessuno usa più per costruire giochi pubblicati. È l'unica voce di questa sezione che la disciplina dichiara in disuso.
...
La storia antica sta nella voce 122, acrostico. Qui interessa il ramo italiano, che «Acrostico» percorre per intero.
...
- **Notarikon** — il metodo con cui la cabala ricava una parola dalle iniziali di altre, che «Notarikon» accosta alla formazione di un acronimo e mette accanto a ghematria e temurah come uno dei tre metodi antichi.
...
- **Quadrato del Sator** — un acrostico che si legge nei due sensi e in tutte e due le direzioni; «Word square» scrive che un quadrato di parole è un tipo di acrostico.
...
Dove si romperebbe: su un pannello di quattro righe corte ci sta mezzo biglietto, quindi la scheda è di carta. In compenso quattro righe di pannello sono esattamente un acrostico di quattro lettere, e questa è una cosa da provare.
...
**È la forma più economica del capitolo, e costa zero in tutte e due le direzioni.** Chi compone non deve contare niente, chi risolve non deve cercare niente. È il caso limite del controllo dell'errore: la verifica sta nel materiale e si fa con un dito, e il costo è tutto spostato sull'ipotesi.

**Il segno tipografico che dice dove guardare è antico quanto la forma.** Tre manoscritti biblici mettono in maiuscolo le iniziali che contano, e la masora le scrive in rosso. Una pagina stampata in bianco e nero non ha il rosso, ma ha il maiuscolo e la spaziatura, e sono la stessa leva. Alla voce 122, acrostico la stessa cosa era stata notata come parte mobile e non come tradizione.
