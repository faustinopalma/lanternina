...
- **Fonti** [Cambio (enigmistica)](https://it.wikipedia.org/wiki/Cambio_(enigmistica)), [Coppia minima](https://it.wikipedia.org/wiki/Coppia_minima), prese il 1 settembre 2026
...
La restrizione non è un dettaglio del repertorio: è quello che rende il gioco finibile a mano. Su *carta* un cambio senza vincoli dà 100 stringhe candidate; ristretto alle vocali ne dà 8, e alle consonanti 45.
...
Dalla tradizione enigmistica italiana. «Cambio (enigmistica)» elenca cinque tipi: **di consonante** — in mezzo alla parola —, **di vocale** — in mezzo —, **di lettera** — in mezzo, e se è consonante diventa vocale o viceversa —, **d'iniziale** e **di finale**. La pagina insiste che il nome nudo non si usa mai e che la natura del cambio va sempre specificata.
...
«Cambio (enigmistica)» è un repertorio senza note e senza misure, e lo dichiara da sé con l'avviso in cima.
...
Da «Cambio (enigmistica)», riscritti: di consonante *carta / casta*; di vocale *Roma / rima*; di lettera *cieco / circo*; di iniziale *casta / pasta*; di finale *conto / conte*; a frase *lancia / l'ascia*; frase a cambio di vocale *la mica / l'amaca*; e la successione *pazzo / pezzo / pizzo / pozzo / puzzo*.

Da «Coppia minima», gli stessi cambi visti da un fonologo: *balla / palla* è un cambio d'iniziale di consonante, *detto / tetto* pure, e servono a mostrare che /b/ e /p/, /d/ e /t/ sono fonemi distinti dell'italiano.
...
Dove si romperebbe: un modello linguistico non può proporre uno scheletro né dire se *pizzo* sia una parola. Che le cinque di P—ZZO siano tutte parole è un giudizio nostro, e su M—LA ne contiamo tre — *mela*, *mola*, *mula* — sempre a giudizio nostro.
