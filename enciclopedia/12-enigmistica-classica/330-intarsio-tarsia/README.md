...
- **Fonti** [Intarsio (enigmistica)](https://it.wikipedia.org/wiki/Intarsio_(enigmistica)) e [Riffle shuffle permutation](https://en.wikipedia.org/wiki/Riffle_shuffle_permutation), prese il 1 settembre 2026; [Incastro (enigmistica)](https://it.wikipedia.org/wiki/Incastro_(enigmistica)), presa il 30 agosto 2026
...
- **Mescolata a ventaglio** — la stessa operazione nella matematica delle permutazioni: «Riffle shuffle permutation» chiama così l'intreccio di due sequenze che conserva l'ordine interno di ognuna, ed è il mazzo di carte tagliato e sfogliato.

## Che cosa se ne sa

«Intarsio (enigmistica)» non contiene nessuna misura. I conti seguono dalla definizione.
...
Da «Intarsio (enigmistica)», riscritti: *asine / censo = ascensione*, dove *asine* è spezzata in *as*, *i*, *ne* e *censo* in *cens*, *o*. E l'intarsio a frase *matassa / tiro = matita rossa*.
...
Il limite tecnico del capitolo non morde: le diciotto stringhe si producono intrecciando due parole date, senza doverle giudicare. Il giudizio «questa è una parola italiana» resta fuori.
...
**Il verso stampabile non è sempre lo stesso.** Alla voce 323, sciarada e alla voce 328, incastro conveniva stampare le letture del totale; qui conviene stampare gli intrecci delle due parole. Per ogni forma con due versi, quale dei due spazi di ricerca stia su un foglio è una domanda da porre, e la risposta cambia da forma a forma.

**Gli esempi delle fonti non sono letture uniche.** Rifacendo a macchina i due esempi di «Intarsio (enigmistica)» si trova che ciascuno ammette due modi di leggere la prima parola dentro il totale. Non è un difetto della pagina: è che l'intarsio, a differenza del lucchetto della voce 326, lucchetto, non determina niente.
