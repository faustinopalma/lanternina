...
- **Fonti** [Auction](https://en.wikipedia.org/wiki/Auction), [Auction theory](https://en.wikipedia.org/wiki/Auction_theory), [Vickrey auction](https://en.wikipedia.org/wiki/Vickrey_auction), [English auction](https://en.wikipedia.org/wiki/English_auction), [Dutch auction](https://en.wikipedia.org/wiki/Dutch_auction), [First-price sealed-bid auction](https://en.wikipedia.org/wiki/First-price_sealed-bid_auction), [Winner's curse](https://en.wikipedia.org/wiki/Winner%27s_curse), [Revenue equivalence](https://en.wikipedia.org/wiki/Revenue_equivalence), [Bid shading](https://en.wikipedia.org/wiki/Bid_shading), [Bidding fee auction](https://en.wikipedia.org/wiki/Bidding_fee_auction), [Game mechanics](https://en.wikipedia.org/wiki/Game_mechanics) sezione «Auction or bidding», tutte lette il 31 agosto 2026; [Asta](https://it.wikipedia.org/wiki/Asta) è una pagina di disambiguazione di 2 540 byte e non serve; [Bidding](https://en.wikipedia.org/wiki/Bidding), [Common value auction](https://en.wikipedia.org/wiki/Common_value_auction) e [Combinatorial auction](https://en.wikipedia.org/wiki/Combinatorial_auction) sono state lette e non aggiungono niente alle altre
...
- **Che cosa pagano gli altri.** Di norma niente. Se pagano tutti, la forma cambia natura: è l'asta a pagamento, e «Bidding fee auction» ne descrive la versione commerciale.
- **La moneta.** «Game mechanics», sezione «Auction or bidding», distingue due casi: si paga con una risorsa del gioco — punti, denaro finto — oppure **l'offerta è la promessa di ottenere un risultato, e chi non lo ottiene paga una penale**. È il meccanismo del contratto nel bridge.
...
La parola viene da *auctus*, participio passato di *augeō*, «io aumento» («Auction»). Le aste sono documentate almeno dal 500 a.C.: Erodoto racconta che a Babilonia si tenevano ogni anno aste di donne da sposare, e che era illegale dare in sposa una figlia fuori dall'asta. Nell'impero romano i soldati piantavano una lancia per terra e vendevano intorno a essa il bottino, schiavi compresi. **Nel 193 d.C. la guardia pretoriana uccise l'imperatore Pertinace e mise all'asta l'impero**: vinse Didio Giuliano a 6 250 dracme per pretoriano, e fu decapitato due mesi dopo. La storia di questa forma è quasi tutta di questo genere, e la scheda la riporta perché è la storia vera.
...
La teoria è del Novecento e comincia con William Vickrey, che dà il nome all'asta a busta chiusa e secondo prezzo. «Revenue equivalence» enuncia il risultato che governa tutta la famiglia: date certe condizioni, **qualunque meccanismo che assegni la cosa agli stessi offerenti produce lo stesso ricavo atteso**.
...
Da «Dutch auction» e da «Auction»: l'asta olandese, dove il prezzo scende e il primo che parla prende. Serve dove ci sono migliaia di lotti da vendere in poche ore — i fiori — e trasforma una trattativa in un istante.

Da «Game mechanics»: nel bridge non si offre denaro ma una promessa. Si dichiara quante prese si faranno, e chi le dichiara di più gioca; se poi non le fa, paga. **È l'unica asta in cui si offre una prestazione futura di sé stessi.**

Da «Bidding fee auction»: l'asta in cui ogni rilancio costa e chi perde ha pagato lo stesso. È la stessa struttura di un'asta normale con una riga cambiata, e la riga cambiata la rovescia.
...
Da «Winner's curse»: un giacimento che vale davvero dieci milioni, stimato da chi fra cinque e venti; vince chi ha detto venti, e scopre dopo.
...
**Il secondo prezzo è la sola regola incontrata in duecentottantaquattro voci che renda la sincerità la scelta migliore per interesse.** Non chiede lealtà, non fa appello a niente, e si dimostra con una tabella. Vale la pena chiedersi quali altre forme dell'elenco abbiano una versione con questa proprietà — la voce 244, autovalutazione con rubrica è la prima da guardare, perché è il posto in cui chi dichiara e chi ha lavorato coincidono.

**La seconda persona vale dodici volte l'ottava, ed è la seconda misura indipendente di questa forma.** La prima era sulle figurine, alla voce 276, cooperazione. Due strutture senza niente in comune danno la stessa curva. Per chi è da solo la conseguenza è la stessa: quello che manca è quasi tutto nel passaggio da uno a due, e quasi niente dopo.
...
**L'asta a candela è una fine imprevedibile ottenuta con una cosa fisica,** ed è la stessa mossa del cubetto di ghiaccio della voce 88, sfida contro un tempo. Un foglio non misura il tempo; una candela sì, e nessuno può metterla in pausa.
