...
- **Fonti** [Integer sequence](https://en.wikipedia.org/wiki/Integer_sequence) e [On-Line Encyclopedia of Integer Sequences](https://en.wikipedia.org/wiki/On-Line_Encyclopedia_of_Integer_Sequences), prese il 30 agosto 2026 da en.wikipedia; [Confirmation bias](https://en.wikipedia.org/wiki/Confirmation_bias) e [Inductive reasoning](https://en.wikipedia.org/wiki/Inductive_reasoning), prese il 30 agosto 2026; l'argomento del polinomio interpolante è nostro e non sta in nessuna delle pagine lette
...
- **Di che cosa sono fatti i termini.** Numeri, lettere, figure, parole. Cambia tutto il resto: con le figure una verifica automatica non è possibile, e con le lettere nemmeno.
...
Su un pannello di quattro righe corte i tre numeri e la domanda ci stanno, e sarebbe una consegna vera. Le tre regole scritte a parole no.

## Che cosa la rende interessante

**Una forma senza risposta unica non è una forma rotta.** Questa presa alla lettera non ha una soluzione, e non per un difetto di chi la pone: per un fatto matematico. La conseguenza è che **si può consegnare senza che nessuno sappia niente**, ed è la prima voce del capitolo di cui si possa dire. Vale la pena separare le forme che hanno una risposta da quelle che hanno un criterio di validità: le seconde non hanno bisogno di nessuno.
