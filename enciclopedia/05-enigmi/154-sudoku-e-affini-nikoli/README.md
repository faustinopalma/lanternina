...
- **Fonti** [Sudoku](https://en.wikipedia.org/wiki/Sudoku), [Mathematics of Sudoku](https://en.wikipedia.org/wiki/Mathematics_of_Sudoku), [Nikoli (publisher)](https://en.wikipedia.org/wiki/Nikoli_(publisher)), [List of Nikoli puzzle types](https://en.wikipedia.org/wiki/List_of_Nikoli_puzzle_types) — questi ultimi due sono la stessa pagina — e [Logic puzzle](https://en.wikipedia.org/wiki/Logic_puzzle), prese il 30 agosto 2026 da en.wikipedia; [Sudoku](https://it.wikipedia.org/wiki/Sudoku), stessa data, da it.wikipedia; il conto delle 288 griglie 4×4 non viene dalle fonti
...
Il sudoku 9×9 non si può costruire a mano con la garanzia dell'unicità. Il 4×4 sì, e con il 4×4 si può fare la cosa che il 9×9 non permette: **costruirne uno e dimostrare da soli che ha una soluzione sola.**
...
Il limite tecnico va scritto qui e non nel foglio: **chi prepara il gioco a mano non può costruire un sudoku 9×9 con soluzione unica e non può verificarne uno.** Non per il limite sulle lettere — qui di lettere non ce ne sono — ma perché l'unicità è un'affermazione su tutte le griglie possibili. Il 4×4 aggira il problema spostandolo: **non lo risolve la macchina, lo risolve la procedura in mano a chi costruisce.**

Su un pannello di poche righe corte una griglia 4×4 ci starebbe — quattro righe da nove caratteri — ma non ci sta la cornice dei riquadri, e senza quella la regola non si vede. È un caso in cui il pannello ha lo spazio e non ha il disegno.

## Che cosa la rende interessante

**Esiste una famiglia intera di giochi progettata per non dipendere da nessuna lingua, e ha un editore e una data.** Nikoli, 1980, con il criterio dichiarato dei giochi «indipendenti dalla cultura». Per un foglio in italiano consegnato a una persona sola, **è l'unica famiglia dell'elenco che non porta con sé il contesto in cui è nata** — che è il modo più comune di sbagliare. Da guardare per intero: sono decine di giochi, tutti con la stessa struttura, e nessuno chiede di sapere niente.
...
**L'unicità della soluzione è la definizione, non la qualità.** In quasi tutte le altre forme dell'elenco una seconda soluzione è un difetto di redazione; qui è la fine del gioco, e non si vede. Sono le forme in cui chi genera senza verificare fa il danno più grande.
