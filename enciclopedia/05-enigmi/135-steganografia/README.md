...
- **La densità.** Quante lettere del testo portano il messaggio e quante sono riempitivo. Più il messaggio è corto rispetto alla copertura, più è facile nasconderlo — «Steganography» lo dice con l'immagine del pagliaio: più grande è il pagliaio, meglio sta l'ago.
...
- **Steganografia sociale** — nascondere il messaggio in un modo di dire, in un riferimento di cultura popolare, in un nome scritto male. «Steganography» la descrive come pratica di comunità sottoposte a censura: il contesto sociale è la chiave.
- **Voce 122, acrostico** — le iniziali dei versi compongono una parola. «Null cipher» dichiara l'acrostico nascosto una forma di cifrario nullo, e l'acrostico dichiarato no.
...
Da un telegramma tedesco della prima guerra mondiale, riportato da «Null cipher»: un messaggio di ventidue parole che parla di embarghi, situazioni gravi e diritto internazionale. Prendendo l'iniziale di ogni parola si legge che una certa nave salpa da New York a giugno. Il testo di copertura ha esattamente il tono dei telegrammi diplomatici che circolavano in quei mesi, ed è per quello che passò.
...
**La steganografia è l'unica forma dell'elenco in cui il compito, per esistere, deve non annunciarsi.** Un foglio che dice «qui c'è un messaggio nascosto» ha già distrutto la proprietà che definisce la forma. Questo confligge in modo diretto con qualunque consegna dichiarata, e la via d'uscita trovata qui — girare il compito dalla parte di chi scrive — la aggira invece di risolverla. Se esista un modo onesto di consegnare a qualcuno una cosa senza dirgli che gliela si sta consegnando resta una domanda aperta.
...
Da verificare: la data e il testo esatto del telegramma tedesco, che «Null cipher» riporta senza fonte primaria; e il seguito della storia di Trevanian, che nella pagina è dato per assodato ma con un solo riferimento.
