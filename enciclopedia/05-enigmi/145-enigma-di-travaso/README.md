...
- **Fonti** [Water pouring puzzle](https://en.wikipedia.org/wiki/Water_pouring_puzzle) e [Einstellung effect](https://en.wikipedia.org/wiki/Einstellung_effect), prese il 30 agosto 2026 da en.wikipedia
...
Il foglio porta i problemi e la tabella; l'aritmetica è quella di una lista di numeri interi, che non è il maneggio delle lettere e non è il soddisfacimento di vincoli. La verifica è nel foglio: ogni riga si controlla con una sottrazione.
...
Tre cose sui numeri. Le capacità e gli obiettivi dei problemi 5 e 7 sono quelli riportati da «Einstellung effect»; **gli altri cinque li ho costruiti io e l'aritmetica l'ho verificata una per una** — 163−14−50 = 99, 43−18−20 = 5, 42−9−12 = 21, 59−20−8 = 31, e per il numero 6, 76−28−6 = 42 mentre 28−3 = 25. La serie originale completa di Luchins non è nella fonte.
