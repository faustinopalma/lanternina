...
- **Fonti** [Zebra Puzzle](https://en.wikipedia.org/wiki/Zebra_Puzzle) e [Logic puzzle](https://en.wikipedia.org/wiki/Logic_puzzle), prese il 30 agosto 2026 da en.wikipedia
...
- **Quante categorie.** «Logic puzzle» dice che possono essere un numero qualunque, ma che la complessità cresce di conseguenza, e che quasi tutti ne hanno **due, tre o al massimo quattro.** Il puzzle della zebra ne ha cinque, ed è per questo che è il caso celebre.
...
- **Table puzzle** — la stessa deduzione senza matrice, perché sarebbe troppo grande o perché c'è un altro aiuto visivo. «Logic puzzle» fa l'esempio della piantina di un paese al posto della griglia, in un enigma sulla posizione dei negozi.
...
- **Voce 154, sudoku e affini (Nikoli)** — la stessa struttura senza parole: «Logic puzzle» li mette esplicitamente nella stessa famiglia, insieme ai nonogrammi e ai labirinti logici.
...
Un foglio può portare la matrice vuota e le regole della notazione, e non può portare l'elenco di indizi: garantire che la soluzione sia una sola è un problema di soddisfacimento di vincoli, e un modello linguistico è misurato male proprio su questo. Quindi si gira il compito, e la cosa da costruire diventa il gioco.
