...
- **Fonti** [Dissection puzzle](https://en.wikipedia.org/wiki/Dissection_puzzle), [Dissection problem](https://en.wikipedia.org/wiki/Dissection_problem), [Hinged dissection](https://en.wikipedia.org/wiki/Hinged_dissection), [Wallace–Bolyai–Gerwien theorem](https://en.wikipedia.org/wiki/Wallace%E2%80%93Bolyai%E2%80%93Gerwien_theorem), [Fold-and-cut theorem](https://en.wikipedia.org/wiki/Fold-and-cut_theorem), [Tessellation](https://en.wikipedia.org/wiki/Tessellation), prese il 30 agosto 2026
...
- **Dissezione a cerniera** — i pezzi legati a catena in punti fissi. Dudeney la rende famosa nel 1907; nel **2007** Erik Demaine e altri dimostrano che **due poligoni di area uguale hanno sempre una dissezione a cerniera**, e danno l'algoritmo per costruirla («Hinged dissection»).
...
- **Piega e taglia** — il teorema del piega-e-taglia: qualunque figura a lati dritti si ricava da un foglio piegato piatto con **un solo taglio dritto** («Fold-and-cut theorem»). È il punto in cui questa voce e la successiva si toccano.
...
Questa forma sta su un foglio meglio di quasi tutte le altre del blocco: basta stampare una figura su carta a quadretti, e le forbici fanno tagli dritti senza tradire niente.
...
**L'obiettivo calcolato invece che dichiarato.** L'area è un invariante, quindi chi riceve il foglio può derivare da sé che cosa deve ottenere. È la prima volta che l'enciclopedia incontra una forma in cui il compito **contiene** la propria consegna, e vale la pena cercarne altre: sono le sole in cui nessuno deve dire la risposta, perché non ce n'è bisogno.

**Sapere che si può fare e saperlo fare bene sono due cose diverse, e qui la distanza è misurata in secoli.** Il teorema del 1807 garantisce che una dissezione esiste; il numero minimo di pezzi fra un triangolo e un quadrato è stato chiuso nel 2024. È il caso più chiaro raccolto di un problema **facile da porre e non risolvibile da chi lo pone**, e la via d'uscita è la stessa già usata tre volte: scegliere una taglia in cui la verifica sta in una tabella.
...
**Il taglio come verbo del rompicapo, e non come supporto.** La voce 43, taglio descrive la stessa forbice dal lato del materiale. Vale la pena guardare quante forme cambino capitolo semplicemente cambiando che cosa si sta chiedendo dello stesso gesto, perché sembrano parecchie.

**La carta a quadretti è un'infrastruttura poco usata.** Rende esatti il taglio, la misura e la verifica, costa quanto un foglio bianco, e trasforma «più o meno» in un numero. Da provare all'indietro su tutte le forme geometriche dell'elenco.
