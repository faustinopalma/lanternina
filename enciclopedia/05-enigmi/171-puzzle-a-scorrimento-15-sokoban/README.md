...
- **Fonti** [Sliding puzzle](https://en.wikipedia.org/wiki/Sliding_puzzle), [15 puzzle](https://en.wikipedia.org/wiki/15_puzzle), [Klotski](https://en.wikipedia.org/wiki/Klotski), [Rush Hour (puzzle)](https://en.wikipedia.org/wiki/Rush_Hour_(puzzle)), [Sokoban](https://en.wikipedia.org/wiki/Sokoban), [Transport puzzle](https://en.wikipedia.org/wiki/Transport_puzzle), [Mechanical puzzle](https://en.wikipedia.org/wiki/Mechanical_puzzle) sezione «Sequential movement», [Gioco del 15](https://it.wikipedia.org/wiki/Gioco_del_15), lette il 31 agosto 2026. I conti sul telaio 3×3 dell'esempio non vengono dalle fonti
...
- **Puzzle a scorrimento con lettere** — molto diffusi dagli anni Cinquanta agli Ottanta secondo «Sliding puzzle»; hanno più soluzioni possibili, perché le parole che si possono formare sono più di una.
...
- **Voce 143, enigma di attraversamento** — «Transport puzzle» mette i due nella stessa categoria: rompicapi in cui niente si aggiunge e niente si perde, e la difficoltà è la strada nello spazio degli stati. Lì però il vincolo è una regola dichiarata a parole, qui è la forma del telaio.
