...
- **Fonti** [Visual cryptography](https://en.wikipedia.org/wiki/Visual_cryptography), [Crittografia visuale](https://it.wikipedia.org/wiki/Crittografia_visuale), [Secret sharing](https://en.wikipedia.org/wiki/Secret_sharing), [Halftone](https://en.wikipedia.org/wiki/Halftone), [Superimposition](https://en.wikipedia.org/wiki/Superimposition), [Anaglyph 3D](https://en.wikipedia.org/wiki/Anaglyph_3D), lette il 2 settembre 2026
...
- **Steganografia visiva** — «Visual cryptography»: con sottocelle 2×2, un bianco diventa tre sottocelle nere e un nero quattro, così che **ogni foglio porti a sua volta un'immagine leggibile**. Il contrasto del segreto cala alla metà.
...
- **Anaglifo** — «Anaglyph 3D»: l'altro modo di sovrapporre due immagini perché l'occhio le separi, con due colori e due filtri. Richiede il colore da tutte e due le parti.
- **Moiré** — «Superimposition»: due strati periodici sovrapposti producono da soli una figura. Vedi la voce 389, moiré.
...
**Un foglio solo non è la prova di niente.** «Visual cryptography» lo scrive per esteso: avendo una delle due parti si può costruire una seconda parte falsa che, sovrapposta, produce **qualunque** immagine si voglia. Un foglio non rivela il segreto e non testimonia nemmeno che ci fosse un segreto.
