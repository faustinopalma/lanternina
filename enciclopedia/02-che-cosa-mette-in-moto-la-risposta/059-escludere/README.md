...
- **Fonti** [Twenty questions](https://en.wikipedia.org/wiki/Twenty_questions), [Binary search](https://en.wikipedia.org/wiki/Binary_search), [Mastermind (board game)](https://en.wikipedia.org/wiki/Mastermind_(board_game)), [Single-access key](https://en.wikipedia.org/wiki/Single-access_key), prese il 30 agosto 2026
...
La versione formale è la ricerca binaria («Binary search», stessa data), e la versione da tavolo è *Mastermind*, inventato nel 1970 da Mordecai Meirowitz e pubblicato nel 1971–72 da Invicta Plastics; deriva dal gioco con carta e penna *Bulls and Cows* («Mastermind (board game)», stessa data). La chiave dicotomica dei naturalisti è l'esclusione messa per iscritto e resa riusabile («Single-access key»).
...
C'è un limite reale: **serve un'altra persona che risponda sì o no.** Il foglio può essere stampato e usato in due, e allora funziona; da solo, no. La variante che regge senza secondo giocatore è quella in cui il bersaglio lo sceglie chi gioca e l'insieme è dato — le pagine di un libro, i giorni dell'anno — e le domande servono a battere il proprio record.
...
**Il costo dichiarato in mosse** è una verifica che non passa da nessuno: il conto è il conto. Va guardato insieme alle altre forme con verifica fisica o aritmetica, che sono la famiglia più numerosa.
...
**Peirce sull'economia della ricerca** — spezzare un'ipotesi nelle sue parti minime e rischiarne una per volta — è un principio di disegno per chi scrive una consegna, prima ancora che un contenuto da proporre.
