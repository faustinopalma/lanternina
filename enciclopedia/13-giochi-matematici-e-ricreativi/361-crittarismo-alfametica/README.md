...
- **Fonti** [Verbal arithmetic](https://en.wikipedia.org/wiki/Verbal_arithmetic), [Henry Dudeney](https://en.wikipedia.org/wiki/Henry_Dudeney), [Sam Loyd](https://en.wikipedia.org/wiki/Sam_Loyd), lette il 1 settembre 2026; nessuna pagina italiana, e il perché è scritto qui sotto

## Che cos'è

Un'operazione aritmetica scritta con lettere al posto delle cifre. Chi risolve deve trovare quale cifra sta sotto ogni lettera. «Verbal arithmetic» dà tre regole, e sono tutto quello che serve: **lettere diverse valgono cifre diverse**, **la prima cifra di un numero non è zero**, e un buon problema **ha una soluzione sola**.
...
**La glossa tratta «crittarismo» e «alfametica» come due nomi della stessa cosa, e la fonte li distingue.** «Verbal arithmetic»: il nome *cryptarithm* fu coniato nel maggio 1931 dall'enigmista Minos — pseudonimo di Simon Vatriquant — sulla rivista belga *Sphinx*, e tradotto *cryptarithmetic* da Maurice Kraitchik nel 1942; **nel 1955 J. A. H. Hunter introdusse la parola *alphametic* per designare i crittarismi le cui lettere formano parole o frasi di senso compiuto.** L'alfametica è un caso particolare del crittarismo, non un suo sinonimo: un crittarismo con lettere qualsiasi resta un crittarismo. La riga dell'elenco mette fra parentesi come glossa quello che è una restrizione, ed è la prima glossa sbagliata trovata nel capitolo 13.

## Da dove viene

Da nessuno che si sappia. «Verbal arithmetic» dice che questi giochi sono antichi e l'inventore è ignoto, e smonta con una data l'idea corrente che li abbia inventati Sam Loyd: nel dicembre 1864 l'*American Agriculturist* ne pubblicò uno, il «Puzzle No. 109», quando Loyd aveva ventitré anni e Dudeney sette. «Henry Dudeney» aggiunge la lettura che quella pubblicazione permette: **l'assenza di regole spiegate nel giornale agricolo suggerisce che il gioco fosse già popolare in America nel 1864.** Un fatto ricavato da quello che una fonte non dice.

Il classico è di Dudeney, uscito sullo *Strand Magazine* del luglio 1924:

`SEND + MORE = MONEY`

«Henry Dudeney» precisa la sua specialità: Dudeney fu il maggiore esponente di questi giochi, «e i suoi erano sempre alfametici», cioè con lettere che formano frasi. La distinzione di Hunter è nata per descrivere il lavoro di Dudeney trent'anni dopo che l'aveva fatto.

**In italiano il nome che porta questa voce dell'elenco non ha una pagina.** `Crittarismo` non esiste su Wikipedia in italiano, controllato il 1 settembre 2026; e nemmeno `Alphametic` e `Cryptarithm` in inglese, che sono rimandi a `Verbal arithmetic`. Il gioco ha tre nomi in inglese e nessuna trattazione in italiano.
...
- **Sudoku e kakuro criptici** — «Verbal arithmetic» dice che l'alfametica si combina con l'uno e con l'altro.
...
**Lo spazio è grande e la deduzione lo azzera.** `SEND + MORE = MONEY` ha otto lettere; le assegnazioni di otto cifre distinte fra dieci sono **1 814 400**, e la fonte dà proprio questo numero come esempio di forza bruta. «Verbal arithmetic» stampa anche la deduzione a mano, in undici passi, che parte da «dalla colonna 5, M = 1, perché è l'unico riporto possibile» e arriva a Y = 2. Il problema è stato risolto due volte, con il metodo per colonne e con l'enumerazione completa delle 1 814 400 assegnazioni: **i due metodi danno la stessa soluzione unica**, ed è quella della fonte — O=0, M=1, Y=2, E=5, N=6, D=7, R=8, S=9, cioè 9567 + 1085 = 10652.
...
Da «Verbal arithmetic», Dudeney, *Strand Magazine*, luglio 1924: `SEND + MORE = MONEY`.

Da «Verbal arithmetic», di autore ignoto: `TO + GO = OUT`.

Da «Verbal arithmetic», *American Agriculturist*, dicembre 1864, «Puzzle No. 109»: il caso che smonta l'attribuzione a Loyd. La fonte lo nomina in nota e non lo riporta.

Da «Verbal arithmetic», Anton Pavlis, 1983: quarantuno addendi e la parola `TESTS`.

Da «Verbal arithmetic»: la divisione scheletrica, in cui la fonte dice che quasi tutte le cifre sono asterischi. Anche di questa non c'è esempio nel testo estratto.
...
Sei lettere, quindi **151 200** assegnazioni possibili; una sola funziona, e sono 30115 + 30115 = 60230. Costruita e verificata con i due metodi, per colonne e a forza bruta. La somma è di una parola con sé stessa, e questo è l'aiuto nascosto: la colonna delle unità diventa `2E` e le cifre possibili per E si dimezzano subito.

## Che cosa la rende interessante

**Il limite del capitolo precedente non morde qui, e vale la pena dire perché.** Là una forma era proponibile solo se chi la componeva sapeva manipolare le lettere dentro le parole e aveva già scritto la risposta. Un'alfametica si compone al contrario — si sceglie prima la chiave, poi si guarda quali parole tornano — quindi la risposta è scritta prima della domanda. Comporre resta difficile e **risolvere non chiede altro che sostituire cifre e sommare**.
